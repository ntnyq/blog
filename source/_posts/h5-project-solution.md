...
H5项目常见问题汇总及解决方案。本篇文章来源于[QDFUNS文章--H5项目常见问题汇总及解决方案](http://www.qdfuns.com/notes/19075/63b3c42852852d29ff7197c53183f0ee.html)。因为这个平台收藏别人的文章后，如果文章被删除了，就找不到了。所以留个存档。<!-- more -->
...
// 再通过media query或者js动态设置html的font-size值
```
